...
def _conversion():
    """The basis conversion, as the KERNEL declares it -- read rather than
    restated, because a second copy of these numbers is a second definition of
    what the basis is."""
    from mathutils import Matrix
    return Matrix(kernel_statement.basis(kernel_statement.BLENDER)["matrix"].tolist())
