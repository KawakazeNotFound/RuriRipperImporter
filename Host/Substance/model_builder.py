...
from ...Kernel.math3d import coordinate as _coordinate
from ...Kernel.unity import (hierarchy, material as unity_material_props,
...
def build_from_prefabs(db, prefabs, name, out_path, options=None, placements=None):
    ...
    for prefab, placement in kept:
        ...
        # the shared rules (Kernel.unity.prefab), so this plugin and
